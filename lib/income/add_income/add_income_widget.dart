                    ...
                    children: [
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'q1ny1778' /* Income Name */,
                            ),
                            hintText: FFLocalizations.of(context).getText(
                              'pp3l1cml' /* Enter bill name */,
                            ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '1ufli95j' /* When was the most recent Payda... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '951wa55t' /* Select Frequency of the Bill..... */,
                            ),
                            icon: Icon(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'xid3od52' /* Description */,
                            ),
                            hintText: FFLocalizations.of(context).getText(
                              'wzoygrpw' /* Enter description */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodyLarge
                                .override(
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '3r4paw7p' /* Select Default Payment Source */,
                            ),
                            icon: Icon(
                              Icons.keyboard_arrow_down_rounded,
                              color: FlutterFlowTheme.of(context).secondaryText,
