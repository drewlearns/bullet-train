...
class _EditBillWidgetState extends State<EditBillWidget> {
  ...
  void initState() {
    ...
    _model.interestRateFocusNode ??= FocusNode();

    _model.cashbackFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final editBillGetBillResponse = snapshot.data!;
        return Title(
            title: 'EditBill',
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model.frequencyValueController ??=
                                  ...
                                  _model.frequencyValue ??=
                                      TppbGroup.getBillCall.frequency(
                                    editBillGetBillResponse.jsonBody,
                                  ),
                                ),
                                ...
                                optionLabels: [
                                  ...
                                  FFLocalizations.of(context).getText(
                                    's9gze5jm' /* Bi-Weekly ( 14 days) */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'u41h179g' /* Monthly ( 30 days ) */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'z4le7m7y' /* Bi-Monthly (60 days ) */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'gluezox8' /* Quarterly ( 90 days ) */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'ndxdfvjb' /* Annually */,
                                  )
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.descriptionTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      TppbGroup.getBillCall.description(
                                        editBillGetBillResponse.jsonBody,
                                      ),
                                      'Loading',
                                    ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FlutterFlowDropDown<int>(
                                controller: _model.dayofmonthValueController ??=
                                    FormFieldController<int>(
                                  _model.dayofmonthValue ??=
                                      TppbGroup.getBillCall.dayofMonth(
                                    editBillGetBillResponse.jsonBody,
                                  ),
                                ),
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  8.0, 8.0, 8.0, 8.0),
                              child: FlutterFlowDropDown<String>(
                                controller: _model.isDebtValueController ??=
                                    FormFieldController<String>(
                                  _model.isDebtValue ??= TppbGroup.getBillCall
                                      .isDebt(
                                        editBillGetBillResponse.jsonBody,
                                      )
                                      ?.toString(),
                                ...
                                onChanged: (val) =>
                                    setState(() => _model.isDebtValue = val),
                                width: 350.0,
                                height: 56.0,
                                textStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.interestRateTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      TppbGroup.getBillCall
                                          .interestRate(
                                  ...
                                  focusNode: _model.interestRateFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'sjzd01qj' /* Interest Rate */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  keyboardType:
                                      const TextInputType.numberWithOptions(
                                          decimal: true),
                                  validator: _model
                                      .interestRateTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(
                                width: 350.0,
                                child: TextFormField(
                                  controller: _model.cashbackTextController ??=
                                      TextEditingController(
                                    text: valueOrDefault<String>(
                                      TppbGroup.getBillCall
                                          .cashBack(
                                  ...
                                  focusNode: _model.cashbackFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                  ...
                                  keyboardType:
                                      const TextInputType.numberWithOptions(
                                          decimal: true),
                                  validator: _model
                                      .cashbackTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                        ...
                        FutureBuilder<ApiCallResponse>(
                          future: TppbGroup.getBillPasswordCall.call(
                            authorizationToken: currentAuthenticationToken,
                            billId: widget.billId,
                          ),
                          builder: (context, snapshot) {
                            ...
                            final listViewGetBillPasswordResponse =
                                snapshot.data!;
                            return ListView(
                                          ...
                                          controller:
                                            ...
                                            text: valueOrDefault<String>(
                                              TppbGroup.getBillPasswordCall
                                                  .secretUsername(
                                                listViewGetBillPasswordResponse
                                                    .jsonBody,
                                              ),
                                              'Loading...',
                                            ),
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.passwordTextController ??=
                                                  TextEditingController(
                                            text: TppbGroup.getBillPasswordCall
                                                .secretPassword(
                                              listViewGetBillPasswordResponse
                                                  .jsonBody,
                                            ),
                        ...
                        Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                _model.apiResultxem =
                                    await TppbGroup.editBillCall.call(
                                  authorizationToken:
                                  ...
                                  dayOfMonth: _model.dayofmonthValue,
                                  frequency: _model.frequencyValue,
                                  isDebt: _model.isDebtValue,
                                  interestRate: double.tryParse(
                                      _model.interestRateTextController.text),
                                  cashBack: TppbGroup.getBillCall
                                      .cashBack(
                                        editBillGetBillResponse.jsonBody,
                                      )
                                      ?.toDouble(),
                                  ...
                                  notificationId: TppbGroup.getBillCall
                                      .notificationId(
                                        editBillGetBillResponse.jsonBody,
                                      )
                                      .toString(),
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content:
                                            Text(TppbGroup.editBillCall.message(
                                          (_model.apiResultxem?.jsonBody ?? ''),
                                        )!),
                                        actions: [
                                          TextButton(
