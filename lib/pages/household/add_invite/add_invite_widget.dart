  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final addInviteGetHouseholdResponse = snapshot.data!;
        return Title(
            title: 'Add Invite',
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'We have invited ${_model.textController.text} to join you at the Purple Piggy Bank! ${TppbGroup.addInviteCall.message(
                                              (_model.apiResultcil?.jsonBody ??
                                                  ''),
                                            )}'),
                                            actions: [
                                              TextButton(
