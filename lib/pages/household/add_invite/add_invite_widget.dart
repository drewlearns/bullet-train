        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              top: true,
              child: Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(8.0, 30.0, 8.0, 30.0),
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((_model.apiResultcil?.succeeded ?? true)) {
                          await showDialog(
                            context: context,
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text(
                                    'We have invited ${_model.textController.text}to join you at the Purple Piggy Bank!'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text(TppbGroup.addInviteCall.message(
