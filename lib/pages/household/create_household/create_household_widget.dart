...
class CreateHouseholdWidget extends StatefulWidget {
  const CreateHouseholdWidget({super.key});

  @override
  State<CreateHouseholdWidget> createState() => _CreateHouseholdWidgetState();
}

class _CreateHouseholdWidgetState extends State<CreateHouseholdWidget> {
