                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.addIncomeOutput =
                                  await TppbGroup.addIncomeCall.call(
                                authorizationToken: currentAuthenticationToken,
                                householdId: widget.householdId,
                                name: _model.textController1.text,
                                amount: _model.textController3.text,
                                firstPayDay: _model.datePicked?.toString(),
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content:
                                          Text(TppbGroup.addIncomeCall.message(
                                        (_model.addIncomeOutput?.jsonBody ??
                                            ''),
                                      )!),
                                      actions: [
                                        TextButton(
