                    ...
                    actions: [
                      Padding(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            _model.apiResultvw0 =
                                await TppbGroup.deleteIncomeJsCall.call(
                              authorizationToken: currentAuthenticationToken,
                              incomeId: widget.incomeId,
                            );
                  ...
                  child: Column(
                    ...
                    children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child:
                                                ...
                                                optionLabels: [
                                                  ...
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'grvuzmwa' /* Weekly - every 7 days */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'su1m2yvw' /* Biweekly - every 14 days */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '9w6es8ja' /* Monthly - every 30 days */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'hz9fklbb' /* Bimonthly - every 60 days */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'neto9c8a' /* Quarterly - every 90 days */,
                                                  ),
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ppynddbu' /* Annually */,
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          _model.apiResultzod =
                              await TppbGroup.editIncomeCall.call(
                            authorizationToken: currentAuthenticationToken,
                            incomeId: widget.incomeId,
                            ...
                            firstPayDay: _model.textController3.text,
                            frequency: _model.dropDownValue3,
                            description: '',
                          ...
                          if ((_model.apiResultzod?.succeeded ?? true)) {
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('Success'),
                                  content: const Text('Updated Income'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
