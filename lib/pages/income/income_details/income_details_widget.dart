...
import 'income_details_model.dart';
export 'income_details_model.dart';
...
class _IncomeDetailsWidgetState extends State<IncomeDetailsWidget> {
  late IncomeDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomeDetailsModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final incomeDetailsGetIncomeResponse = snapshot.data!;
        return Title(
                                                    ...
                                                    Text(
                                                      valueOrDefault<String>(
                                                        TppbGroup.getIncomeCall
                                                            .name(
                                                          incomeDetailsGetIncomeResponse
                                                              .jsonBody,
                                                        ),
                                                        'Loading...',
                                                      ),
