...
class _EditTransactionWidgetState extends State<EditTransactionWidget> {
  ...
  void initState() {
    ...
    _model.transactionDateFieldFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final editTransactionGetTransactionResponse = snapshot.data!;
        return Title(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: Text(
                                      ...
                                      (_model.deleteTransaction?.jsonBody ??
                                          ''),
                                    )!),
                                    actions: [
                                      TextButton(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                        ...
                                                        text: TppbGroup
                                                            .getTransactionCall
                                                            .amount(
                                                              editTransactionGetTransactionResponse
                                                                  .jsonBody,
                                                            )
                                                            ?.toString(),
                                                      ),
                                                ...
                                                Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                                .transactionDateFieldTextController ??=
                                                            TextEditingController(
                                                          text: TppbGroup
                                                              .getTransactionCall
                                                              .transactionDate(
