                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '80t5dkrt' /* Are you sure you want to 
dele... */
                                              ,
                                            ),
                        ...
                        onPressed: () async {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: const Text('Are you absoutely sure?'),
                                    content: const Text(
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  ...
                                  content: const Text('Sorry to see you go '),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/DALLE_2024-05-26_12.02.33_-_Create_an_edited_version_of_a_logo_featuring_a_stylized_cartoon_pig_within_a_circle,_dressed_in_a_suit_with_a_purple_striped_bow_tie._Change_the_pigs.webp',
                        width: 300.0,
                        height: 313.0,
                        fit: BoxFit.cover,
                      ),
