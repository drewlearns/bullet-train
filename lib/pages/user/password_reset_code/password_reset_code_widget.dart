...
import 'password_reset_code_model.dart';
export 'password_reset_code_model.dart';

class PasswordResetCodeWidget extends StatefulWidget {
  const PasswordResetCodeWidget({
    super.key,
    required this.email,
  });
  ...
  @override
  State<PasswordResetCodeWidget> createState() =>
      _PasswordResetCodeWidgetState();
}

class _PasswordResetCodeWidgetState extends State<PasswordResetCodeWidget> {
  late PasswordResetCodeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PasswordResetCodeModel());
